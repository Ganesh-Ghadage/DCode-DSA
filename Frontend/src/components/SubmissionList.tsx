...
const SubmissionsList = ({ submissions, isLoading }: props) => {
  ...
  return (
    <div className="space-y-4">
      {submissions.map((submission) => {
        const avgMemory = calculateAverageMemory(submission.memory ? submission.memory : '');
        const avgTime =  calculateAverageTime(submission.time ? submission.time : '');
