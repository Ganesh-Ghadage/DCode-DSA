		...
		<div className="fixed inset-0 bg-black/80 bg-opacity-50 flex items-center justify-center z-10">
			...
			<div className="bg-base-100 rounded-lg shadow-xl w-full max-w-md z-50">
				{authUser ? (
					...
					<div className="flex flex-col justify-center items-center gap-10 p-4 py-10 relative">
						<div className="flex justify-between items-center">
							<h3 className="text-xl font-bold">You need to login to create Playlist</h3>
							<button
								onClick={onClose}
