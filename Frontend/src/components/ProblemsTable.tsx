...
const ProblemsTable = ({ problems }: props) => {
	...
	return (
		<div className="mb-6 mt-4 w-full md:px-10">
			...
			<div className="flex flex-col-reverse md:flex-row justify-center gap-8 ">
				<div className="w-full max-w-6xl">
					...
					<div className="flex flex-wrap justify-between items-center mb-6 gap-4">
						...
						/>
						<select
							className="select select-bordered bg-base-200 w-full md:w-1/4"
							value={difficulty}
					...
					<div className="overflow-x-auto rounded-xl shadow-md">
						<table className="table table-zebra md:table-lg bg-base-200 text-base-content">
										...
										return (
											...
											>
														...
														{(problem.tags || []).map(
															(tag, idx) =>
																tag !== "Demo" && (
																	<span
																		key={idx}
																		className="badge badge-outline badge-warning text-xs md:font-bold h-fit w-fit"
																	>
																		{tag}
																	</span>
																)
												...
												<td className="min-w-40">
													<div className="flex flex-col md:flex-row gap-2 items-start md:items-center flex-wrap text-wrap">
														{authUser?.role === "ADMIN" && (
														...
														<button
															className="btn btn-sm btn-outline flex gap-2 items-center text-wrap"
				...
				<div className="bg-base-300 rounded-xl max-h-[120dvh] h-fit w-full md:max-w-60 ">
